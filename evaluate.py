...
# Load models
opus_tokenizer, opus_model = load_model_and_tokenizer("Helsinki-NLP/opus-mt-en-de")
t5_tokenizer, t5_model = load_model_and_tokenizer("google-t5/t5-small")

# Function to translate
def translate_text(model, tokenizer, text, use_prompt=False):
    if use_prompt:
        text = f"translate English to German: {text}"
...
if page == "Evaluation":
    ...
    st.write("Compare English-to-German translations using multiple models and evaluation metrics.")
    ...
    if st.button("Translate"):
        if input_text.strip():
            ...
            t5_translation = translate_text(t5_model, t5_tokenizer, input_text, use_prompt=True)
